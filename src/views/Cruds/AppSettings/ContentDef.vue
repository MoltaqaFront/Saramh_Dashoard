<template>
  <div class="crud_form_wrapper">
    ...
    <div class="form_title_wrapper">
      <h4>{{ $t("SIDENAV.AppContent.management") }}</h4>
    </div>
    <!-- End:: Title -->
    ...
    <div class="single_step_form_content_wrapper">
      <form @submit.prevent="validateFormInputs">
        <div class="row">
          ...
          <!-- Start:: Name Input -->
          <base-input col="6" type="textarea" :placeholder="$t('TABLES.Notifications.contentAr')"
            v-model.trim="data.contentAr" @input="validateInput" required />
          <!-- End:: Name Input -->

          <!-- Start:: Name Input -->
          <base-input col="6" type="textarea" :placeholder="$t('TABLES.Notifications.contentEn')"
            v-model.trim="data.contentEn" @input="removeArabicCharacters" @copy="onCopy" @paste="onPaste" required />
